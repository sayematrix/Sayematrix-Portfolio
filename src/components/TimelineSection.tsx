...
export const TimelineSection: React.FC = () => {
  return (
    <section className="py-20 bg-[#101216] border-b border-[#242830] relative" id="timeline">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative border-l-2 border-[#242830] ml-4 sm:ml-8 space-y-8 pl-6 sm:pl-10">
          {TIMELINE_MILESTONES.map((item) => (
            <div key={item.year} className="relative group">
              {/* Timeline Node Circle */}
              <div className="absolute -left-[31px] sm:-left-[47px] top-1 w-4 h-4 rounded-full bg-[#101216] border-2 border-emerald-400 group-hover:bg-emerald-400 transition-colors" />

              <div className="p-6 rounded-xl bg-[#08090B] border border-[#242830] group-hover:border-emerald-500/50 transition-all">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="text-lg font-sans font-bold text-[#F5F5F5]">
                    {item.title}
                  </h3>
                </div>
                ...
                <p className="text-xs font-sans text-[#9299A5] leading-relaxed mb-4">
                  {item.description}
                </p>
