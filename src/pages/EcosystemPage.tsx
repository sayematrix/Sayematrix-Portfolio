  ...
  return (
    <div className="pt-28 pb-20 bg-[#08090B] min-h-screen">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="space-y-4 border-b border-[#242830] pb-8">
          ...
          <p className="text-sm font-sans text-[#9299A5] max-w-xl">
            ...
            return (
              <button
                ...
                className={`p-4 rounded-xl border text-left transition-all ${
                  isActive
                    ? 'bg-[#14171C] border-2 shadow-xl'
                    : 'bg-[#101216] border-[#242830] hover:border-emerald-500/40'
                }`}
              ...
              >
                ...
                <span className="text-xs font-mono font-bold text-[#F5F5F5] block truncate">
                  {d.brand}
                </span>
              </button>
            );
        ...
        <div className="bg-[#101216] p-8 rounded-2xl border border-[#242830] space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-[#242830]">
            <div>
              <span
              ...
              <h2 className="text-3xl font-sans font-black text-[#F5F5F5] mt-2">
                {domain.brand}
              </h2>
            </div>

            <div className="text-xs font-mono text-emerald-400">
              STATUS: <strong className="text-[#F5F5F5]">ACTIVE ECOSYSTEM NODE</strong>
            </div>
          </div>

          <p className="text-base font-sans text-[#F5F5F5] leading-relaxed">
            {domain.description}
          </p>

          <div className="p-4 rounded-xl bg-[#14171C] border border-[#242830] space-y-1">
            <span className="text-[10px] font-mono text-[#9299A5] uppercase">PRIMARY FOCUS AREA</span>
            <p className="text-sm font-sans font-bold text-emerald-300">{domain.focusArea}</p>
          </div>

          <div>
            <span className="text-xs font-mono text-[#9299A5] uppercase block mb-3 font-bold">
              UNLIMITED TOPICS & EXPANSION MODULES
            </span>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-3">
              {domain.topics.map((topic) => (
                <div key={topic} className="p-3 rounded-lg bg-[#14171C] border border-[#242830] text-xs font-mono text-[#F5F5F5] flex items-center gap-2">
          ...
          {domain.instagramUrl && (
            <div className="pt-4 border-t border-[#242830] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
              <div>
                <span className="text-xs font-mono font-bold text-pink-400 uppercase block mb-0.5">INSTAGRAM BRAND HANDLE</span>
                <span className="text-xs font-mono text-[#9299A5]">{domain.instagramUrl}</span>
              </div>
              <a
                href={domain.instagramUrl}
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg bg-gradient-to-r from-pink-500/20 to-purple-500/20 border border-pink-500/40 text-xs font-mono font-bold text-[#F5F5F5] hover:border-pink-400 transition-all group"
              >
